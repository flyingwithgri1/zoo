...
public class CommonUtil {
	...
	public static void testTime(){
		...
		System.out.println("2017年10月17日 13:11，转换后的时间为：" + convertDate("2017年10月17日 13:11"));
		System.out.println("明天" + convertDate("明天"));*/
		Calendar calendar = Calendar.getInstance();
		//注意下面的代码，前面的参数Calendar.DAY_OF_YEAR 天，后面的参数1，表示加1，
		//注意下面的代码，前面的参数Calendar.HOUR_OF_DAY 小时后面的参数1，表示加1，
